...
<html>
	...
	<body>
		...
		<div class="body">
			...
			<td class="content">view calendar

<h2>Calendar</h2><h5><?php $query = "select g.groupname gname, e.name ename, e.event_date edate, e.start_time etime from groups g left outer join events e on e.group_id = g.groupname;"; 
